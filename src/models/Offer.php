...
class Offer extends Model
{
    ...
    public function rules(): array
    {
        return [
            ...
            [['nr', 'title', 'header', 'footer', 'template_slug', 'total_gross', 'total_net', 'total_taxes', 'total', 'currency_id', 'language_id'], 'string'],
            [['is_valid_from', 'is_valid_to', 'is_valid_until', 'updated_at'], 'string'],
